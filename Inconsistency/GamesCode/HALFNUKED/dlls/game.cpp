...
cvar_t	nosuitcharger = { "duke_nosuitcharger", "1", FCVAR_SERVER };
...
cvar_t	sk_kevlar1	= { "sk_kevlar1","0" };			
cvar_t	sk_kevlar2 = { "sk_kevlar2", "0" };
cvar_t	sk_kevlar3 = { "sk_kevlar3", "0" };

cvar_t	sk_kevlarused1 = { "sk_kevlarused1", "0" };
cvar_t	sk_kevlarused2 = { "sk_kevlarused2", "0" };
cvar_t	sk_kevlarused3 = { "sk_kevlarused3", "0" };
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	CVAR_REGISTER ( &sk_kevlar1 );
	CVAR_REGISTER ( &sk_kevlar2 );
	CVAR_REGISTER ( &sk_kevlar3 );

	CVAR_REGISTER ( &sk_kevlarused1 );
	CVAR_REGISTER ( &sk_kevlarused2 );
	CVAR_REGISTER ( &sk_kevlarused3 );
...
// END REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	SERVER_COMMAND("exec skill_duke.cfg\n");
}
