...
class CZombie_ba : public CBaseMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_zombie_barney, CZombie_ba );

const char *CZombie_ba::pAttackHitSounds[] = 
{
...
const char *CZombie_ba::pAttackMissSounds[] = 
{
	"zombie/claw_miss1.wav",
	"zombie/claw_miss2.wav",
};

const char *CZombie_ba::pAttackSounds[] = 
{
	"zombie/zo_attack1.wav",
	"zombie/zo_attack2.wav",
};

const char *CZombie_ba::pIdleSounds[] = 
{
	"zombie/zo_idle1.wav",
	"zombie/zo_idle2.wav",
	"zombie/zo_idle3.wav",
...
const char *CZombie_ba::pAlertSounds[] = 
{
...
const char *CZombie_ba::pPainSounds[] = 
{
	"zombie/zo_pain1.wav",
	"zombie/zo_pain2.wav",
};
...
//=========================================================
void CZombie_ba :: SpawnCrab( void )
{
...
//=========================================================
void CZombie_ba :: SetYawSpeed ( void )
{
	int ys;
...
int CZombie_ba :: TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
...
void CZombie_ba :: PainSound( void )
{
...
void CZombie_ba :: AlertSound( void )
{
	int pitch = 95 + RANDOM_LONG(0,9);
...
void CZombie_ba :: IdleSound( void )
{
	int pitch = 95 + RANDOM_LONG(0,9);
...
void CZombie_ba :: AttackSound( void )
{
...
//=========================================================
void CZombie_ba :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	switch( pEvent->event )
	{
...
int CZombie_ba::IgnoreConditions ( void )
{
