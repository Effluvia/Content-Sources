...
class CBarney_suit : public CTalkMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
LINK_ENTITY_TO_CLASS( monster_barney_suit, CBarney_suit );

TYPEDESCRIPTION	CBarney_suit::m_SaveData[] = 
{
	DEFINE_FIELD( CBarney_suit, m_iBaseBody, FIELD_INTEGER ), //LRC
	DEFINE_FIELD( CBarney_suit, m_fGunDrawn, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBarney_suit, m_painTime, FIELD_TIME ),
	DEFINE_FIELD( CBarney_suit, m_checkAttackTime, FIELD_TIME ),
	DEFINE_FIELD( CBarney_suit, m_lastAttackCheck, FIELD_BOOLEAN ),
	DEFINE_FIELD( CBarney_suit, m_flPlayerDamage, FIELD_FLOAT ),
};

IMPLEMENT_SAVERESTORE( CBarney_suit, CTalkMonster );
...
Schedule_t slBarney1EnemyDraw[] = 
{
	{
		tlBarney1EnemyDraw,
		ARRAYSIZE ( tlBarney1EnemyDraw ),
		0,
		0,
		"Barney Enemy Draw"
	}
...
DEFINE_CUSTOM_SCHEDULES( CBarney_suit )
{
	slBa1Follow,
	slBarney1EnemyDraw,
	slBa1FaceTarget,
...
IMPLEMENT_CUSTOM_SCHEDULES( CBarney_suit, CTalkMonster );

void CBarney_suit :: StartTask( Task_t *pTask )
{
	CTalkMonster::StartTask( pTask );	
}

void CBarney_suit :: RunTask( Task_t *pTask )
{
	switch ( pTask->iTask )
	{
...
//=========================================================
int CBarney_suit :: ISoundMask ( void) 
{
...
// relationship table.
//=========================================================
int	CBarney_suit :: Classify ( void )
{
...
//=========================================================
void CBarney_suit :: AlertSound( void )
{
	if ( m_hEnemy != NULL )
	{
		if ( FOkToSpeak() )
...
//=========================================================
void CBarney_suit :: SetYawSpeed ( void )
{
	int ys;
...
//=========================================================
void CBarney_suit :: BarneyFirePistol ( void )
{
...
//=========================================================
void CBarney_suit :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	switch( pEvent->event )
	{
...
void CBarney_suit :: Spawn()
{
	...
	if (pev->model)
		...
		SET_MODEL(ENT(pev), "models/barney_suit.mdl");
	...
	if (pev->health == 0) //LRC
		pev->health			= gSkillData.barneysuitHealth;
	...
	MonsterInit();
	SetUse(&CBarney_suit :: FollowerUse );
}

//=========================================================
// Precache - precaches all resources this monster needs
//=========================================================
void CBarney_suit :: Precache()
{
	if (pev->model)
		PRECACHE_MODEL((char*)STRING(pev->model)); //LRC
	else
		PRECACHE_MODEL("models/barney_suit.mdl");
...
int CBarney_suit :: TakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
...
// PainSound
//=========================================================
void CBarney_suit :: PainSound ( void )
{
...
// DeathSound 
//=========================================================
void CBarney_suit :: DeathSound ( void )
{
	switch (RANDOM_LONG(0,2))
	{
...
void CBarney_suit::TraceAttack( entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int bitsDamageType)
{
...
void CBarney_suit::Killed( entvars_t *pevAttacker, int iGib )
{
...
Schedule_t* CBarney_suit :: GetScheduleOfType ( int Type )
{
	Schedule_t *psched;
...
// of the proper type.
//=========================================================
Schedule_t *CBarney_suit :: GetSchedule ( void )
{
...
MONSTERSTATE CBarney_suit :: GetIdealState ( void )
{
...
void CBarney_suit::DeclineFollowing( void )
{
...
//
//=========================================================
class CDeadBarney_suit : public CBaseMonster
{
public:
	void Spawn( void );
...
char *CDeadBarney_suit::m_szPoses[] = { "lying_on_back", "lying_on_side", "lying_on_stomach" };

void CDeadBarney_suit::KeyValue( KeyValueData *pkvd )
{
...
LINK_ENTITY_TO_CLASS( monster_barney_dead_suit, CDeadBarney_suit );

//=========================================================
// ********** DeadBarney SPAWN **********
//=========================================================
void CDeadBarney_suit :: Spawn( )
{
	PRECACHE_MODEL("models/barney_suit.mdl");
	SET_MODEL(ENT(pev), "models/barney_suit.mdl");
