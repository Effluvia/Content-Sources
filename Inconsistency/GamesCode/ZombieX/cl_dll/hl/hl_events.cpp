...
void Game_HookEvents( void )
{
	...
	gEngfuncs.pfnHookEvent( "events/eagel1.sc",					EV_FireEagel1 );
	gEngfuncs.pfnHookEvent( "events/eagel2.sc",					EV_FireEagel2 );
	...
	gEngfuncs.pfnHookEvent( "events/mp41a.sc",					EV_FireMP41a );
	gEngfuncs.pfnHookEvent( "events/mp41a2.sc",					EV_FireMP41a2 );
