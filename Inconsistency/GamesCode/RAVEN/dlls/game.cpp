...
cvar_t	sv_disableai = {"sv_disableai","0", FCVAR_SERVER|FCVAR_SPONLY };
...
cvar_t	sk_shambler_dmg_swipe1 = {"sk_shambler_dmg_swipe1","0"};
cvar_t	sk_shambler_dmg_swipe2 = {"sk_shambler_dmg_swipe2","0"};
cvar_t	sk_shambler_dmg_swipe3 = {"sk_shambler_dmg_swipe3","0"};

cvar_t	sk_shambler_dmg_smash1 = {"sk_shambler_dmg_smash1","0"};
cvar_t	sk_shambler_dmg_smash2 = {"sk_shambler_dmg_smash2","0"};
cvar_t	sk_shambler_dmg_smash3 = {"sk_shambler_dmg_smash3","0"};

cvar_t	sk_shambler_dmg_zap1 = {"sk_shambler_dmg_zap1","0"};
cvar_t	sk_shambler_dmg_zap2 = {"sk_shambler_dmg_zap2","0"};
cvar_t	sk_shambler_dmg_zap3 = {"sk_shambler_dmg_zap3","0"};

// Shambler
cvar_t	sk_soldier_health1 = {"sk_soldier_health1","0"};
cvar_t	sk_soldier_health2 = {"sk_soldier_health2","0"};
cvar_t	sk_soldier_health3 = {"sk_soldier_health3","0"};

cvar_t	sk_soldier_pellets1 = {"sk_soldier_pellets1","0"};
cvar_t	sk_soldier_pellets2 = {"sk_soldier_pellets2","0"};
cvar_t	sk_soldier_pellets3 = {"sk_soldier_pellets3","0"};
...
// Boris
cvar_t	sk_boris_health1	= {"sk_boris_health1","0"};
cvar_t	sk_boris_health2	= {"sk_boris_health2","0"};
cvar_t	sk_boris_health3	= {"sk_boris_health3","0"};

cvar_t	sk_boris_dmg_zap1 = {"sk_boris_dmg_zap1","0"};
cvar_t	sk_boris_dmg_zap2 = {"sk_boris_dmg_zap2","0"};
cvar_t	sk_boris_dmg_zap3 = {"sk_boris_dmg_zap3","0"};
...
// Hgrunt 
cvar_t	sk_fgrunt_health1 = {"sk_fgrunt_health1","0"};
cvar_t	sk_fgrunt_health2 = {"sk_fgrunt_health2","0"};
cvar_t	sk_fgrunt_health3 = {"sk_fgrunt_health3","0"};

cvar_t	sk_fgrunt_kick1 = {"sk_fgrunt_kick1","0"};
cvar_t	sk_fgrunt_kick2 = {"sk_fgrunt_kick2","0"};
cvar_t	sk_fgrunt_kick3 = {"sk_fgrunt_kick3","0"};

cvar_t	sk_fgrunt_pellets1 = {"sk_fgrunt_pellets1","0"};
cvar_t	sk_fgrunt_pellets2 = {"sk_fgrunt_pellets2","0"};
cvar_t	sk_fgrunt_pellets3 = {"sk_fgrunt_pellets3","0"};

cvar_t	sk_fgrunt_gspeed1 = {"sk_fgrunt_gspeed1","0"};
cvar_t	sk_fgrunt_gspeed2 = {"sk_fgrunt_gspeed2","0"};
cvar_t	sk_fgrunt_gspeed3 = {"sk_fgrunt_gspeed3","0"};
...
// Rifle Round
cvar_t	sk_plr_rifle_bullet1 = {"sk_plr_rifle_bullet1","0"};
cvar_t	sk_plr_rifle_bullet2 = {"sk_plr_rifle_bullet2","0"};
cvar_t	sk_plr_rifle_bullet3 = {"sk_plr_rifle_bullet3","0"};
...
void GameDLLInit( void )
{
	...
	CVAR_REGISTER (&sv_disableai);

// REGISTER CVARS FOR SKILL LEVEL STUFF
	// Shambler
	CVAR_REGISTER ( &sk_dog_health1 );// {"sk_dog_health1","0"};
	CVAR_REGISTER ( &sk_dog_health2 );// {"sk_dog_health2","0"};
	CVAR_REGISTER ( &sk_dog_health3 );// {"sk_dog_health3","0"};

	CVAR_REGISTER ( &sk_dog_dmg_bite1 );// {"sk_dog_dmg_bite1","0"};
	CVAR_REGISTER ( &sk_dog_dmg_bite2 );// {"sk_dog_dmg_bite2","0"};
	CVAR_REGISTER ( &sk_dog_dmg_bite3 );// {"sk_dog_dmg_bite3","0"};

	// Shambler
	CVAR_REGISTER ( &sk_shambler_health1 );// {"sk_shambler_health1","0"};
	CVAR_REGISTER ( &sk_shambler_health2 );// {"sk_shambler_health2","0"};
	CVAR_REGISTER ( &sk_shambler_health3 );// {"sk_shambler_health3","0"};

	CVAR_REGISTER ( &sk_shambler_dmg_swipe1 );// {"sk_shambler_dmg_swipe1","0"};
	CVAR_REGISTER ( &sk_shambler_dmg_swipe2 );// {"sk_shambler_dmg_swipe2","0"};
	CVAR_REGISTER ( &sk_shambler_dmg_swipe3 );// {"sk_shambler_dmg_swipe3","0"};

	CVAR_REGISTER ( &sk_shambler_dmg_smash1 );// {"sk_shambler_dmg_smash1","0"};
	CVAR_REGISTER ( &sk_shambler_dmg_smash2 );// {"sk_shambler_dmg_smash2","0"};
	CVAR_REGISTER ( &sk_shambler_dmg_smash3 );// {"sk_shambler_dmg_smash3","0"};

	CVAR_REGISTER ( &sk_shambler_dmg_zap1 );// {"sk_shambler_dmg_zap1","0"};
	CVAR_REGISTER ( &sk_shambler_dmg_zap2 );// {"sk_shambler_dmg_zap2","0"};
	CVAR_REGISTER ( &sk_shambler_dmg_zap3 );// {"sk_shambler_dmg_zap3","0"};

	// Soldier
	CVAR_REGISTER ( &sk_soldier_health1 );// {"sk_soldier_health1","0"};
	CVAR_REGISTER ( &sk_soldier_health2 );// {"sk_soldier_health2","0"};
	CVAR_REGISTER ( &sk_soldier_health3 );// {"sk_soldier_health3","0"};

	CVAR_REGISTER ( &sk_soldier_pellets1 );// {"sk_soldier_pellets1","0"};
	CVAR_REGISTER ( &sk_soldier_pellets2 );// {"sk_soldier_pellets2","0"};
	CVAR_REGISTER ( &sk_soldier_pellets3 );// {"sk_soldier_pellets3","0"};
	...
	// Boris
	CVAR_REGISTER ( &sk_boris_health1 );// {"sk_boris_health1","0"};
	CVAR_REGISTER ( &sk_boris_health2 );// {"sk_boris_health2","0"};
	CVAR_REGISTER ( &sk_boris_health3 );// {"sk_boris_health3","0"};

	CVAR_REGISTER ( &sk_boris_dmg_zap1 );// {"sk_boris_dmg_zap1","0"};
	CVAR_REGISTER ( &sk_boris_dmg_zap2 );// {"sk_boris_dmg_zap2","0"};
	CVAR_REGISTER ( &sk_boris_dmg_zap3 );// {"sk_boris_dmg_zap3","0"};
	...
	// Fgrunt 
	CVAR_REGISTER ( &sk_fgrunt_health1 );// {"sk_fgrunt_health1","0"};
	CVAR_REGISTER ( &sk_fgrunt_health2 );// {"sk_fgrunt_health2","0"};
	CVAR_REGISTER ( &sk_fgrunt_health3 );// {"sk_fgrunt_health3","0"};
											   
	CVAR_REGISTER ( &sk_fgrunt_kick1 );// {"sk_fgrunt_kick1","0"};
	CVAR_REGISTER ( &sk_fgrunt_kick2 );// {"sk_fgrunt_kick2","0"};
	CVAR_REGISTER ( &sk_fgrunt_kick3 );// {"sk_fgrunt_kick3","0"};
						
	CVAR_REGISTER ( &sk_fgrunt_pellets1 );
	CVAR_REGISTER ( &sk_fgrunt_pellets2 );
	CVAR_REGISTER ( &sk_fgrunt_pellets3 );
						
	CVAR_REGISTER ( &sk_fgrunt_gspeed1 );
	CVAR_REGISTER ( &sk_fgrunt_gspeed2 );
	CVAR_REGISTER ( &sk_fgrunt_gspeed3 );
	...
	// Scoped Rifle Round
	CVAR_REGISTER ( &sk_plr_rifle_bullet1 );// {"sk_plr_rifle_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_rifle_bullet2 );// {"sk_plr_rifle_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_rifle_bullet3 );// {"sk_plr_rifle_bullet3","0"};
	...
	// 556 Round
	CVAR_REGISTER ( &sk_plr_nail1 );// {"sk_plr_556_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_nail2 );// {"sk_plr_556_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_nail3 );// {"sk_plr_556_bullet3","0"};
	...
	CVAR_REGISTER ( &sk_eagle_bullet1 );// {"sk_eagle_bullet1","0"};
	CVAR_REGISTER ( &sk_eagle_bullet2 );// {"sk_eagle_bullet2","0"};
	CVAR_REGISTER ( &sk_eagle_bullet3 );// {"sk_eagle_bullet3","0"};
