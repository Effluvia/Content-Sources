...
TYPEDESCRIPTION	CFuncTrain::m_SaveData[] = 
{
	...
	DEFINE_FIELD( CFuncTrain, m_pPrevTarget, FIELD_CLASSPTR ),
};
...
void CFuncTrain :: Blocked( CBaseEntity *pOther )
{
	...
	pOther->TakeDamage( pev, pevOther, pev->dmg, DMG_CRUSH );
}
...
void CFuncTrain :: Spawn( void )
{
	...
	if(pev->renderamt == 0 && pev->rendermode == kRenderTransColor)
	{
...
void CFuncTrackTrain :: NextVirtual( void )
{
	float time = 0.5;
...
LINK_ENTITY_TO_CLASS( env_modeltracktrain, CModelTrackTrain );

void CModelTrackTrain :: Spawn( void )
{
	if ( pev->speed == 0 )
		m_speed = 100;
	else
...
void CModelTrackTrain :: Precache( void )
{
	PRECACHE_MODEL( (char* )STRING(pev->model) );
}

void CModelTrackTrain :: StopSound( void )
{
}

void CModelTrackTrain :: UpdateSound( void )
{

}

void CModelTrackTrain :: NextVirtual( void )
{
	float time = 0.5;
