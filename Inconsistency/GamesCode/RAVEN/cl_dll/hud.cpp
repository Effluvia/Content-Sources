...
//	m_hsprFont = LoadSprite("sprites/%d_font.spr");
	...
	gBlackHole.VidInit();
	SVD_VidInit();
	gModelCamera.VidInit();
	gWeather.VidInit();
	gAliasRenderer.VidInit();

	// HACK - Make sure this is set
	gEngfuncs.pfnClientCmd("sv_zmax 16384");
	gEngfuncs.pfnServerCmd("sv_zmax 16384");
}
