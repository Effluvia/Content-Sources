...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	// creeper
	CVAR_REGISTER ( &sk_creeper_health1 );// {"sk_creeper_health1","0"};
	CVAR_REGISTER ( &sk_creeper_health2 );// {"sk_creeper_health3","0"};
	CVAR_REGISTER ( &sk_creeper_health3 );// {"sk_creeper_health3","0"};

	// Zombie
	CVAR_REGISTER ( &sk_glenn_health1 );// {"sk_zombie_health1","0"};
	CVAR_REGISTER ( &sk_glenn_health2 );// {"sk_zombie_health3","0"};
	CVAR_REGISTER ( &sk_glenn_health3 );// {"sk_zombie_health3","0"};

	CVAR_REGISTER ( &sk_glenn_dmg_one_slash1 );// {"sk_zombie_dmg_one_slash1","0"};
	CVAR_REGISTER ( &sk_glenn_dmg_one_slash2 );// {"sk_zombie_dmg_one_slash2","0"};
	CVAR_REGISTER ( &sk_glenn_dmg_one_slash3 );// {"sk_zombie_dmg_one_slash3","0"};

	CVAR_REGISTER ( &sk_glenn_dmg_both_slash1 );// {"sk_zombie_dmg_both_slash1","0"};
	CVAR_REGISTER ( &sk_glenn_dmg_both_slash2 );// {"sk_zombie_dmg_both_slash2","0"};
	CVAR_REGISTER ( &sk_glenn_dmg_both_slash3 );// {"sk_zombie_dmg_both_slash3","0"};

	CVAR_REGISTER ( &sk_plr_goldengun_bullet1 );
	CVAR_REGISTER ( &sk_plr_goldengun_bullet2 );
	CVAR_REGISTER ( &sk_plr_goldengun_bullet3 );

	// Zombie
	CVAR_REGISTER ( &sk_sinistar_health1 );// {"sk_zombie_health1","0"};
	CVAR_REGISTER ( &sk_sinistar_health2 );// {"sk_zombie_health3","0"};
	CVAR_REGISTER ( &sk_sinistar_health3 );// {"sk_zombie_health3","0"};

	CVAR_REGISTER ( &sk_sinistar_dmg_one_slash1 );// {"sk_zombie_dmg_one_slash1","0"};
	CVAR_REGISTER ( &sk_sinistar_dmg_one_slash2 );// {"sk_zombie_dmg_one_slash2","0"};
	CVAR_REGISTER ( &sk_sinistar_dmg_one_slash3 );// {"sk_zombie_dmg_one_slash3","0"};

	CVAR_REGISTER ( &sk_sinistar_dmg_both_slash1 );// {"sk_zombie_dmg_both_slash1","0"};
	CVAR_REGISTER ( &sk_sinistar_dmg_both_slash2 );// {"sk_zombie_dmg_both_slash2","0"};
	CVAR_REGISTER ( &sk_sinistar_dmg_both_slash3 );// {"sk_zombie_dmg_both_slash3","0"};
