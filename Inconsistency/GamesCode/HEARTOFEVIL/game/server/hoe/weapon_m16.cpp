...
class CWeaponM16 : public CHLMachineGun
{
	DECLARE_DATADESC();
public:
	DECLARE_CLASS( CWeaponM16, CHLMachineGun );
...
//	void	SecondaryAttack( void );
	...
	int		GetMinBurst() { return 3; } // NPC animation is 3 shots per sequence, plus we don't want a long
	int		GetMaxBurst() { return 3; } // burst to prevent the NPC from avoiding a nearby zombie

	virtual void Equip( CBaseCombatCharacter *pOwner );
	bool	Reload( void );

	float	GetFireRate( void ) { return 0.085; } // from HL1 m_flNextPrimaryAttack = m_flNextPrimaryAttack + 0.085;
...
//	int		WeaponRangeAttack2Condition( float flDot, float flDist );
	...
	{
		static const Vector coneNPC = VECTOR_CONE_5DEGREES;
...
//-----------------------------------------------------------------------------
void CWeaponM16::Equip( CBaseCombatCharacter *pOwner )
{
...
// Output : Activity
//-----------------------------------------------------------------------------
Activity CWeaponM16::GetPrimaryAttackActivity( void )
{
