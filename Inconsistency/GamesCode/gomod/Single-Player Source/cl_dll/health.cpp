...
//	m_HUD_test = gHUD.GetSpriteIndex( "test" );
...
int CHudHealth::Draw(float flTime)
{
	...
	if (gHUD.m_iWeaponBits & (1<<(WEAPON_SUIT)))
	{
		...
		// New code for BETA watermark

	//	x = ScreenWidth ;

	
	//	SPR_Set(gHUD.GetSprite(m_HUD_test), r, g, b); 
	//	SPR_DrawAdditive(0, x-238, y-50, &gHUD.GetSpriteRect(m_HUD_test));
