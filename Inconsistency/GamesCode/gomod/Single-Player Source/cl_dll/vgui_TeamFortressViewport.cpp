...
TeamFortressViewport::TeamFortressViewport(int x,int y,int wide,int tall) : Panel(x,y,wide,tall), m_SchemeManager(wide,tall)
{
	...
	m_pSettingsMenu = NULL; // Settings MENU
	m_pCSWeaponsMenu = NULL; // CSWEAPONS MENU
	m_pHL2MonstersMenu = NULL; // HL2Monsters MENU
	m_pRenderMenu = NULL; // Render MENU
	m_pGeneralMenu = NULL; // VGUI General 
	m_pScoreBoard = NULL;
	...
	CreateSettingsMenu(); // SETTINGS MENU
	CreateCSWeaponsMenu(); // CSWEAPONS MENU
	CreateHL2MonstersMenu(); // CHL2MONSTERS MENU
	CreateRenderMenu();	// Render MENU
	CreateGeneralMenu(); // VGUI General 
	CreateSpectatorMenu();
	CreateScoreBoard();
	// Init command menus
	m_iNumMenus = 0;
...
void TeamFortressViewport::Initialize( void )
{
   ...
   if (m_pGeneralMenu)
   {
        m_pGeneralMenu->setVisible( false );
   }
   ...
   if (m_pHL2MonstersMenu)
   {
        m_pHL2MonstersMenu->setVisible( false );
   }
   ...
   if (m_pWeaponsMenu)
   {
        m_pCSWeaponsMenu->setVisible( false );
   }
   ...
   if (m_pRenderMenu)
   {
        m_pRenderMenu->setVisible( false );
   }
...
void TeamFortressViewport::ShowVGUIMenu( int iMenu )
{
    ...
    case MENU_SETTINGSMENU:
        pNewMenu = ShowSettingsMenu();
        break;
   


	
    case MENU_CSWEAPONSMENU:
        pNewMenu = ShowCSWeaponsMenu();
        break;
    

    case MENU_HL2MONSTERSMENU:
        pNewMenu = ShowHL2MonstersMenu();
        break;
    

    case MENU_RENDERMENU:
        pNewMenu = ShowRenderMenu();
        break;
  



    case MENU_GENERALMENU:
        pNewMenu = ShowGeneralMenu();
        break;
...
CMenuPanel* TeamFortressViewport::ShowSettingsMenu()
{
    // Don't open menus in demo playback 
    if ( gEngfuncs.pDemoAPI->IsPlayingback() )
        return NULL;

    m_pSettingsMenu->Reset();
    return m_pSettingsMenu;
}

void TeamFortressViewport::CreateSettingsMenu()
{
    // Create the panel 
    m_pSettingsMenu = new CSettingsMenu(100, false, 0, 0, ScreenWidth, ScreenHeight);
    m_pSettingsMenu->setParent(this);
    m_pSettingsMenu->setVisible( false );
}
...
// Start - CSWEAPONS MENU
//====================================================================================== 
// WEAPONS MENU
//====================================================================================== 

CMenuPanel* TeamFortressViewport::ShowCSWeaponsMenu()
{
    // Don't open menus in demo playback 
    if ( gEngfuncs.pDemoAPI->IsPlayingback() )
        return NULL;

    m_pCSWeaponsMenu->Reset();
    return m_pCSWeaponsMenu;
}

void TeamFortressViewport::CreateCSWeaponsMenu()
{
    // Create the panel 
    m_pCSWeaponsMenu = new CCSWeaponsMenu(100, false, 0, 0, ScreenWidth, ScreenHeight);
    m_pCSWeaponsMenu->setParent(this);
    m_pCSWeaponsMenu->setVisible( false );
}
...
// RENDER MENU
//====================================================================================== 
CMenuPanel* TeamFortressViewport::ShowRenderMenu()
{
    // Don't open menus in demo playback 
    if ( gEngfuncs.pDemoAPI->IsPlayingback() )
        return NULL;
    ...
    m_pRenderMenu->Reset();
    return m_pRenderMenu;
}

void TeamFortressViewport::CreateRenderMenu()
{
    // Create the panel 
    m_pRenderMenu = new CRenderMenu(100, false, 0, 0, ScreenWidth, ScreenHeight);
    m_pRenderMenu->setParent(this);
    m_pRenderMenu->setVisible( false );
}
...
//====================================================================================== 
// OUR HL2Monsters Menu
//====================================================================================== 

CMenuPanel* TeamFortressViewport::ShowHL2MonstersMenu()
{
    // Don't open menus in demo playback 
    if ( gEngfuncs.pDemoAPI->IsPlayingback() )
        return NULL;

    m_pHL2MonstersMenu->Reset();
    return m_pHL2MonstersMenu;
}

void TeamFortressViewport::CreateHL2MonstersMenu()
{
    // Create the panel 
    m_pHL2MonstersMenu = new CHL2MonstersMenu(100, false, 0, 0, ScreenWidth, ScreenHeight);
    m_pHL2MonstersMenu->setParent(this);
    m_pHL2MonstersMenu->setVisible( false );
}
...
CMenuPanel* TeamFortressViewport::ShowGeneralMenu()
{
    // Don't open menus in demo playback 
    if ( gEngfuncs.pDemoAPI->IsPlayingback() )
        return NULL;

    m_pGeneralMenu->Reset();
    return m_pGeneralMenu;
}

void TeamFortressViewport::CreateGeneralMenu()
{
    // Create the panel 
    m_pGeneralMenu = new CGeneralMenu(100, false, 0, 0, ScreenWidth, ScreenHeight);
    m_pGeneralMenu->setParent(this);
    m_pGeneralMenu->setVisible( false );
}
