...
CSqueak g_Snark;
//CHandFlare g_HandFlare;
CRemoveTool g_RemoveTool;//REMOVETOOL
CPunch g_Punch;//PUNCHES
CHKMP5 g_HKMP5;// CS MP5 WEAPON
CM3 g_M3;// CS M3 WEAPON
CP228 g_P228;// CS P228 WEAPON
CMAC10 g_MAC10;// CS MAC10 WEAPON
CGLOCK18 g_GLOCK18;// CS GLOCK18 WEAPON
CP90 g_P90;// CS P90 WEAPON
CAK47 g_AK47;// CS AK47 WEAPON
CPHYSGUN g_PHYSGUN;// PHYSGUN WEAPON
//CDuplicator g_Duplicator;// DUPLICATOR WEAPON
CM4A1 g_M4A1;// CS M4A1 WEAPON
CUSP g_USP;// CS USP WEAPON
CFIVESEVEN g_FIVESEVEN;// CS FIVESEVEN WEAPON
CXM1014 g_XM1014;// CS XM1014 WEAPON
CUMP45 g_UMP45;// CS UMP45 WEAPON
CDEAGLE g_DEAGLE;// CS DEAGLE WEAPON
CPoserTool g_PoserTool;// POSERTOOL WEAPON
CTMP g_TMP;// TMP WEAPON
...
/*
=====================
CBaseEntity::FireBulletsRemoveTool
...
/*
=====================
CBaseEntity::FireBulletsRemoveToolRender
...
/*
=====================
CBaseEntity::FireBulletsDuplicator
...
/*
=====================
CBaseEntity::FireBulletsDuplicatorSelect
...
//	HUD_PrepEntity( &g_HandFlare, &player );
	HUD_PrepEntity( &g_RemoveTool, &player );//REMOVETOOL
	HUD_PrepEntity( &g_Punch	,&player );//PUNCH
	HUD_PrepEntity( &g_HKMP5	, &player ); //WEAPON CS MP5
	HUD_PrepEntity( &g_M3		, &player ); //WEAPON CS M3
	HUD_PrepEntity( &g_P228		, &player ); //WEAPON CS P228
	HUD_PrepEntity( &g_MAC10	, &player ); //WEAPON CS MAC10
	HUD_PrepEntity( &g_GLOCK18	, &player ); //WEAPON CS GLOCK18
	HUD_PrepEntity( &g_P90		, &player ); //WEAPON CS P90
	HUD_PrepEntity( &g_AK47		, &player ); //WEAPON AK47
	HUD_PrepEntity( &g_PHYSGUN	, &player ); //WEAPON PHYSGUN
//	HUD_PrepEntity( &g_Duplicator	, &player ); //WEAPON Duplicator
	HUD_PrepEntity( &g_M4A1		, &player ); //WEAPON M4A1
	HUD_PrepEntity( &g_USP		, &player ); //WEAPON USP
	HUD_PrepEntity( &g_FIVESEVEN	, &player ); //WEAPON FIVESEVEN
	HUD_PrepEntity( &g_XM1014		, &player ); //WEAPON XM1014
	HUD_PrepEntity( &g_UMP45		, &player ); //WEAPON UMP45
	HUD_PrepEntity( &g_DEAGLE		, &player ); //WEAPON DEAGLE
	HUD_PrepEntity( &g_PoserTool	, &player ); //WEAPON POSERTOOL
	HUD_PrepEntity( &g_TMP			, &player );//TMP
...
void HUD_WeaponsPostThink( local_state_s *from, local_state_s *to, usercmd_t *cmd, double time, unsigned int random_seed )
{
	...
	switch ( from->client.m_iId )
	{
		...
		case WEAPON_REMOVETOOL:
			pWeapon = &g_RemoveTool;
			break;
		...
		case WEAPON_HKMP5://WEAPON CS MP5
			pWeapon = &g_HKMP5;
			break;


		case WEAPON_M3://WEAPON CS M3
			pWeapon = &g_M3;
			break;

		case WEAPON_P228://WEAPON CS P228
			pWeapon = &g_P228;
			break;


		case WEAPON_MAC10://WEAPON CS MAC10
			pWeapon = &g_MAC10;
			break;

		case WEAPON_GLOCK18://WEAPON CS GLOCK18
			pWeapon = &g_GLOCK18;
			break;

		case WEAPON_P90://WEAPON CS P90
			pWeapon = &g_P90;
			break;
	...
	//	case WEAPON_DUPLICATOR://WEAPON DUPLICATOR
	//		pWeapon = &g_Duplicator;
	//		break;

		case WEAPON_M4A1://WEAPON M4A1
			pWeapon = &g_M4A1;
			break;
		...
		case WEAPON_FIVESEVEN://WEAPON FIVESEVEN
			pWeapon = &g_FIVESEVEN;
			break;
		...
		case WEAPON_UMP45://WEAPON UMP45
			pWeapon = &g_UMP45;
			break;



		case WEAPON_DEAGLE://WEAPON DEAGLE
			pWeapon = &g_DEAGLE;
			break;


		case WEAPON_POSERTOOL://WEAPON POSERTOOL
			pWeapon = &g_PoserTool;
			break;
		

			
		case WEAPON_TMP://WEAPON TMP
			pWeapon = &g_TMP;
			break;
