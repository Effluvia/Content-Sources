...
class CFirstMenu; 
class CWeaponsMenu; // WeaponsMenu
class CSettingsMenu; // SettingsMenu
class CCSWeaponsMenu;//CS WeaponsMenu
class CHL2MonstersMenu;//HL2 MONSTERS Menu
class CRenderMenu; // Render Menu
class CGeneralMenu; // General Menu
...
private:
    ...
    CMenuPanel*  ShowSettingsMenu( void );
    ...
    void         CreateCSWeaponsMenu( void );
    CMenuPanel*  ShowCSWeaponsMenu( void );
    


    void         CreateHL2MonstersMenu( void );
    CMenuPanel*  ShowHL2MonstersMenu( void );
 


    void         CreateGeneralMenu( void );
    CMenuPanel*  ShowGeneralMenu( void );
  




    void         CreateRenderMenu( void );
    CMenuPanel*  ShowRenderMenu( void );
...
public:
	...
	CFirstMenu      *m_pFirstMenu; 
	CWeaponsMenu    *m_pWeaponsMenu; // WEAPONS MENU
	CCSWeaponsMenu  *m_pCSWeaponsMenu; // CSWEAPONS MENU
	CSettingsMenu   *m_pSettingsMenu; // Settings MENU
	CHL2MonstersMenu *m_pHL2MonstersMenu; // HL2 Monsters MENU
	CRenderMenu     *m_pRenderMenu; // Render MENU
	CGeneralMenu     *m_pGeneralMenu; // VGUI General
...
//  VGUI 
//============================================================ 
class CSettingsMenu : public CMenuPanel
{
private:
    CommandButton       *m_pCancelButton;
	CTransparentPanel   *m_pPanel; 
...
public:
    CSettingsMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall);
...
//  VGUI
//============================================================ 
class CCSWeaponsMenu : public CMenuPanel
{
private:
    CommandButton       *m_pCancelButton;
	CTransparentPanel   *m_pPanel; 
...
public:
    CCSWeaponsMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall);
};
...
//================================================================ 
// First Hl2 Monsters Menu
//============================================================ 
class CHL2MonstersMenu : public CMenuPanel
{
private:
    CommandButton       *m_pCancelButton;
	CTransparentPanel   *m_pPanel; 
...
public:
    CHL2MonstersMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall);
	void SetActiveInfo( int iShowText ); // VGUI Hl2 Monsters Menu 
};
// End -  Hl2 Monsters Menu 
...
// RENDER MENU
//============================================================ 
class CRenderMenu: public CMenuPanel
{
private:
    CommandButton       *m_pCancelButton;
	CTransparentPanel   *m_pPanel; 
...
public:
    CRenderMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall);
...
// General VGUI menu! 
//============================================================ 
class CGeneralMenu : public CMenuPanel
{
private:
    CommandButton       *m_pCancelButton;
	CTransparentPanel   *m_pPanel; 
...
public:
    CGeneralMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall);
	void SetActiveInfo( int iShowText );
};
