...
CFirstMenu :: CFirstMenu(int iTrans, int iRemoveMe, int x, int y, int wide, int tall) : CMenuPanel(iTrans, iRemoveMe, x,y,wide,tall)
{
	...
	// Imagen Hgrunt
    m_pMyPicture = new CImageLabel( "hgrunt", 1, 60);
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Imagen Hgrunt
	...
	// Imagen Ally Otis
    m_pMyPicture = new CImageLabel( "otis", 75, 310);
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - Ally Otis 
    ...
    m_pSpeak = new CommandButton( "", 76, 310, 70, 59);
    m_pSpeak->setContentAlignment( vgui::Label::a_center );
    m_pSpeak->setParent( m_pPanel );
	...
	// Imagen  ichthyosaur
    m_pMyPicture = new CImageLabel( "ichthyosaur", 1, 310);
    m_pMyPicture->setVisible( true );
    m_pMyPicture->setParent( m_pPanel );
    // End - ichthyosaur
