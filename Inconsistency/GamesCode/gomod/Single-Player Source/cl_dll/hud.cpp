...
void CHud :: Init( void )
{
	...
	CVAR_CREATE( "scroll_up","0",0);
	CVAR_CREATE( "motion_blur","0",FCVAR_ARCHIVE); // MOTION BLUR CVAR
	CVAR_CREATE( "shadows", "1", FCVAR_ARCHIVE );// shadows
	CVAR_CREATE( "glow", "0", FCVAR_ARCHIVE );// Glow
	...
	g_ParticleCount = gEngfuncs.pfnRegisterVariable("cl_particlecount", "100", FCVAR_CLIENTDLL | FCVAR_ARCHIVE ); //BP
	g_ParticleDebug = gEngfuncs.pfnRegisterVariable("cl_particledebug", "0", FCVAR_CLIENTDLL | FCVAR_ARCHIVE );//BP
	g_ParticleSorts = gEngfuncs.pfnRegisterVariable("cl_particlesorts", "3", FCVAR_CLIENTDLL | FCVAR_ARCHIVE );//BP
