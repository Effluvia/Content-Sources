...
#define	GONOME_AE_ATTACK_BOTH		0x03
#define	GONOME_AE_ATTACK_SPIT		0x07

// headcrab jumps from zombie
#define     GONOME_AE_CRAB1          0x04
#define     GONOME_AE_CRAB2          0x05
#define     GONOME_AE_CRAB3          0x06
// headcrab jumps from zombie


#define GONOME_FLINCH_DELAY			2		// at most one flinch every n secs
#define GONOME_CRAB					"monster_headcrab" // headcrab jumps from zombie
...
TYPEDESCRIPTION	CGonome::m_SaveData[] = 
{
	...
	DEFINE_FIELD( CGonome, m_ally, FIELD_INTEGER ),
};
...
void CGonome :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	//		ALERT( at_console, "Slash right!\n" );
			...
			CBaseEntity *pHurt = CheckTraceHullAttack( 70, 20, DMG_SLASH );
			if ( pHurt )
			{
...
void CGonome :: Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/svencoop/gonome.mdl");
...
void CGonome :: Precache()
{
	...
	PRECACHE_MODEL("models/svencoop/gonome.mdl");
	...
	UTIL_PrecacheOther( GONOME_CRAB ); // headcrab jumps from zombie
}	
...
//=========================================================
void CGonome :: SpawnCrab( void )
{
     CBaseEntity *pCrab = CBaseEntity::Create( GONOME_CRAB, pev->origin, pev->angles, edict() ); // create the crab
