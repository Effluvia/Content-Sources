...
int g_fSchockTrooperQuestion;				// true if an idle grunt asked a question. Cleared when someone answers.
...
class CSchockTrooper : public CSquadMonster
{
public:
	void Spawn( void );
	void Precache( void );
	...
	static const char *pShockTrooperSentences[];
};

LINK_ENTITY_TO_CLASS( monster_shock_trooper, CSchockTrooper );

TYPEDESCRIPTION	CSchockTrooper::m_SaveData[] = 
{
	DEFINE_FIELD( CSchockTrooper, m_flNextGrenadeCheck, FIELD_TIME ),
	DEFINE_FIELD( CSchockTrooper, m_flNextPainTime, FIELD_TIME ),
//	DEFINE_FIELD( CHGrunt, m_flLastEnemySightTime, FIELD_TIME ), // don't save, go to zero
	DEFINE_FIELD( CSchockTrooper, m_vecTossVelocity, FIELD_VECTOR ),
	DEFINE_FIELD( CSchockTrooper, m_fThrowGrenade, FIELD_BOOLEAN ),
	DEFINE_FIELD( CSchockTrooper, m_fStanding, FIELD_BOOLEAN ),
	DEFINE_FIELD( CSchockTrooper, m_fFirstEncounter, FIELD_BOOLEAN ),
	DEFINE_FIELD( CSchockTrooper, m_cClipSize, FIELD_INTEGER ),
	DEFINE_FIELD( CSchockTrooper, m_voicePitch, FIELD_INTEGER ),
//  DEFINE_FIELD( CShotgun, m_iBrassShell, FIELD_INTEGER ),
//  DEFINE_FIELD( CShotgun, m_iShotgunShell, FIELD_INTEGER ),
	DEFINE_FIELD( CSchockTrooper, m_iSentence, FIELD_INTEGER ),
};

IMPLEMENT_SAVERESTORE( CSchockTrooper, CSquadMonster );

const char *CSchockTrooper::pShockTrooperSentences[] = 
{
...
// started moving.
//=========================================================
void CSchockTrooper :: SpeakSentence( void )
{
	...
	if (FOkToSpeak())
	{
		SENTENCEG_PlayRndSz( ENT(pev), pShockTrooperSentences[ m_iSentence ], STROOPER_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
		JustSpoke();
	}
}
...
//=========================================================
int CSchockTrooper::IRelationship ( CBaseEntity *pTarget )
{
...
//=========================================================
void CSchockTrooper :: GibMonster ( void )
{
	Vector	vecGunPos;
	Vector	vecGunAngles;
	...
	{// throw a gun if the grunt has one
		...
		CBaseEntity *pGun;
		if (FBitSet( pev->weapons, STROOPER_SHOTGUN ))
		{
		...
		if (FBitSet( pev->weapons, STROOPER_GRENADELAUNCHER ))
		{
...
//=========================================================
int CSchockTrooper :: ISoundMask ( void )
{
...
//=========================================================
BOOL CSchockTrooper :: FOkToSpeak( void )
{
...
//=========================================================
//=========================================================
void CSchockTrooper :: JustSpoke( void )
{
...
//=========================================================
void CSchockTrooper :: PrescheduleThink ( void )
{
...
//=========================================================
BOOL CSchockTrooper :: FCanCheckAttacks ( void )
{
...
// CheckMeleeAttack1
//=========================================================
BOOL CSchockTrooper :: CheckMeleeAttack1 ( float flDot, float flDist )
{
	CBaseMonster *pEnemy;
...
//=========================================================
BOOL CSchockTrooper :: CheckRangeAttack1 ( float flDot, float flDist )
{
...
// attack. 
//=========================================================
BOOL CSchockTrooper :: CheckRangeAttack2 ( float flDot, float flDist )
{
	if (! FBitSet(pev->weapons, (STROOPER_HANDGRENADE | STROOPER_GRENADELAUNCHER)))
	{
		return FALSE;
	}
...
//=========================================================
void CSchockTrooper :: TraceAttack( entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int bitsDamageType)
{
...
//=========================================================
int CSchockTrooper :: TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int bitsDamageType )
{
...
//=========================================================
void CSchockTrooper :: SetYawSpeed ( void )
{
	int ys;
...
void CSchockTrooper :: IdleSound( void )
{
	if (FOkToSpeak() && (g_fSchockTrooperQuestion || RANDOM_LONG(0,1)))
	{
		if (!g_fSchockTrooperQuestion)
		{
			// ask question or make statement
			switch (RANDOM_LONG(0,2))
			{
			case 0: // check in
				SENTENCEG_PlayRndSz(ENT(pev), "HG_CHECK", STROOPER_SENTENCE_VOLUME, ATTN_NORM, 0, m_voicePitch);
				g_fSchockTrooperQuestion = 1;
				break;
			case 1: // question
				SENTENCEG_PlayRndSz(ENT(pev), "HG_QUEST", STROOPER_SENTENCE_VOLUME, ATTN_NORM, 0, m_voicePitch);
				g_fSchockTrooperQuestion = 2;
				break;
			case 2: // statement
				SENTENCEG_PlayRndSz(ENT(pev), "HG_IDLE", STROOPER_SENTENCE_VOLUME, ATTN_NORM, 0, m_voicePitch);
				break;
			}
		}
		else
		{
			switch (g_fSchockTrooperQuestion)
			{
			case 1: // check in
				SENTENCEG_PlayRndSz(ENT(pev), "HG_CLEAR", STROOPER_SENTENCE_VOLUME, ATTN_NORM, 0, m_voicePitch);
				break;
			case 2: // question 
				SENTENCEG_PlayRndSz(ENT(pev), "HG_ANSWER", STROOPER_SENTENCE_VOLUME, ATTN_NORM, 0, m_voicePitch);
				break;
			}
			g_fSchockTrooperQuestion = 0;
		}
		JustSpoke();
	}
}
...
//=========================================================
void CSchockTrooper :: CheckAmmo ( void )
{
	if ( m_cAmmoLoaded <= 0 )
	{
...
// relationship table.
//=========================================================
int	CSchockTrooper :: Classify ( void )
{
...
//=========================================================
//=========================================================
CBaseEntity *CSchockTrooper :: Kick( void )
{
	TraceResult tr;
...
Vector CSchockTrooper :: GetGunPosition( )
{
	if (m_fStanding )
	{
...
// Shoot
//=========================================================
void CSchockTrooper :: Shoot ( void )
{
	if (m_hEnemy == NULL)
	{
		return;
...
// Shoot
//=========================================================
void CSchockTrooper :: Shotgun ( void )
{
	if (m_hEnemy == NULL)
	{
		return;
...
//=========================================================
void CSchockTrooper :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	Vector	vecShootDir;
	...
	switch( pEvent->event )
	{
		...
		{
			if ( FBitSet( pev->weapons, STROOPER_9MMAR ))
			{
				Shoot();
		...
		case STROOPER_AE_CAUGHT_ENEMY:
		{
			if ( FOkToSpeak() )
			{
				SENTENCEG_PlayRndSz(ENT(pev), "HG_ALERT", STROOPER_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
				 JustSpoke();
			}
...
// Spawn
//=========================================================
void CSchockTrooper :: Spawn()
{
	Precache( );

	SET_MODEL(ENT(pev), "models/svencoop/strooper.mdl");
	...
	if (pev->weapons == 0)
	{
		...
		pev->weapons = STROOPER_9MMAR | STROOPER_HANDGRENADE;
	...
	else if (FBitSet( pev->weapons, STROOPER_GRENADELAUNCHER ))
	{
...
//=========================================================
void CSchockTrooper :: Precache()
{
	PRECACHE_MODEL("models/svencoop/strooper.mdl");

	PRECACHE_SOUND( "shocktrooper/gr_mgun1.wav" );
	PRECACHE_SOUND( "shocktrooper/gr_mgun2.wav" );
	...
	PRECACHE_SOUND( "shocktrooper/gr_reload1.wav" );
...
// start task
//=========================================================
void CSchockTrooper :: StartTask ( Task_t *pTask )
{
...
// RunTask
//=========================================================
void CSchockTrooper :: RunTask ( Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_GRUNT_FACE_TOSS_DIR:
...
// PainSound
//=========================================================
void CSchockTrooper :: PainSound ( void )
{
...
// DeathSound 
//=========================================================
void CSchockTrooper :: DeathSound ( void )
{
	switch ( RANDOM_LONG(0,2) )
	{
	case 0:	
...
*/
DEFINE_CUSTOM_SCHEDULES( CSchockTrooper )
{
	slShockTrooperFail,
...
IMPLEMENT_CUSTOM_SCHEDULES( CSchockTrooper, CSquadMonster );

//=========================================================
// SetActivity 
//=========================================================
void CSchockTrooper :: SetActivity ( Activity NewActivity )
{
	...
	case ACT_RANGE_ATTACK2:
		...
		if ( pev->weapons & STROOPER_HANDGRENADE )
		{
			// get toss anim
...
// Get Schedule!
//=========================================================
Schedule_t *CSchockTrooper :: GetSchedule( void )
{
	...
	if ( HasConditions(bits_COND_HEAR_SOUND) )
	{
		...
		if ( pSound)
		{
			if (pSound->m_iType & bits_SOUND_DANGER)
			{
				...
				if (FOkToSpeak())
				{
					SENTENCEG_PlayRndSz( ENT(pev), "HG_GREN", STROOPER_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
					JustSpoke();
				}
					...
					else 
					{
						...
						if (FOkToSpeak())// && RANDOM_LONG(0,1))
						{
							if ((m_hEnemy != NULL) && m_hEnemy->IsPlayer())
								...
								// monster
								SENTENCEG_PlayRndSz( ENT(pev), "HG_MONST", STROOPER_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
...
// can grenade launch
			...
			else if ( FBitSet( pev->weapons, STROOPER_GRENADELAUNCHER) && HasConditions ( bits_COND_CAN_RANGE_ATTACK2 ) && OccupySlot( bits_SLOTS_HGRUNT_GRENADE ) )
			{
...
// can't see enemy
			else if ( HasConditions( bits_COND_ENEMY_OCCLUDED ) )
			{
				if ( HasConditions( bits_COND_CAN_RANGE_ATTACK2 ) && OccupySlot( bits_SLOTS_HGRUNT_GRENADE ) )
				{
					...
					if (FOkToSpeak())
					{
						SENTENCEG_PlayRndSz( ENT(pev), "HG_THROW", STROOPER_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
						JustSpoke();
					}
					return GetScheduleOfType( SCHED_RANGE_ATTACK2 );
				}
				...
				else
				{
					...
					if (FOkToSpeak() && RANDOM_LONG(0,1))
					{
						SENTENCEG_PlayRndSz( ENT(pev), "HG_TAUNT", STROOPER_SENTENCE_VOLUME, GRUNT_ATTN, 0, m_voicePitch);
						JustSpoke();
					}
...
//=========================================================
//=========================================================
Schedule_t* CSchockTrooper :: GetScheduleOfType ( int Type ) 
{
	switch	( Type )
	{
