...
void CGameRules::RefreshSkillData ( void )
{
	...
	gSkillData.gonomeSlash = GetSkillCvar( "sk_gonome_slash");
...
// PLAYER WEAPONS
	...
	// CS M3 Round
	gSkillData.plrDmgBM3 = GetSkillCvar( "sk_plr_BM3_bullet");

	// CS P228 Round
	gSkillData.plrDmgP228 = GetSkillCvar( "sk_plr_P228_bullet");
	...
	// CS USP Round
	gSkillData.plrDmgUSP = GetSkillCvar( "sk_plr_USP_bullet");



	// CS FIVESEVEN Round
	gSkillData.plrDmgFIVE= GetSkillCvar( "sk_plr_FIVE_bullet");
	...
	// CS MP5 Round
	gSkillData.plrDmgHKMP5 = GetSkillCvar( "sk_plr_HKMP5_bullet");
	...
	// CS UMP Round
	gSkillData.plrDmgUMP = GetSkillCvar( "sk_plr_UMP_bullet");
	...
	// Hand Flare
	gSkillData.plrDmgHandFlare = GetSkillCvar( "sk_plr_hand_flare");
