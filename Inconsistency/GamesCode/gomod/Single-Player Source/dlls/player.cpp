...
TYPEDESCRIPTION	CBasePlayer::m_playerSaveData[] = 
{
	...
	DEFINE_FIELD( CBasePlayer, m_iWeapons2, FIELD_INTEGER ), //NEW FOR BREAK-WEAPON LIMIT !
...
void CBasePlayer::WaterMove()
{
	...
	if (pev->waterlevel == 2  && m_flFallVelocity > 500)
	{
			...
			MESSAGE_BEGIN(MSG_ALL, gmsgParticles);
					...
					WRITE_SHORT(iDefaultImpactWater);
...
CBaseEntity *FindEntityForwardPlayer( CBaseEntity *pMe )
{
	TraceResult tr;
...
void CBasePlayer::PreThink(void)
{
	...
	hdr_strength = strength;
	hdr_blur = blur;
	hdr_dark = darken;

		iLights = GETENTITYILLUM( ENT ( pev ) );

		if(CVAR_GET_FLOAT("hdr_simulate") == 0)
		{
			//Nothing
		}
		else
		{
			...
			if (iLights <= 50 )
			{
				CLIENT_COMMAND(pClient,"glow_strength %f\n",strength);
				CLIENT_COMMAND(pClient,"glow_blur_steps %f\n",blur);
				CLIENT_COMMAND(pClient,"glow_darken_steps %f\n",darken);
			}
			else
			{
				
				hdr_strength = hdr_strength - iLights;
				hdr_blur = hdr_blur - iLights;
				hdr_dark = hdr_dark + iLights;
...
void CBasePlayer::CheatImpulseCommands( int iImpulse )
{
	...
	// Todos los monsters para spawnear
	case 200: //Barney
		{
	...
	case 204://Zombie
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_fast_zombie", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			ALERT(at_console,"AAAAAAAAAAAAAAA");
			break;
		}
	...
	case 205://Headcarb
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_fastheadcrab", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}

	case 206://Alien grunt
		{
	...
	case 207://Alien Slave
		{
		
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("func_grass", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 208://Gargantua
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_gargantua", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
    ...
    case 209://Bloater
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_bloater", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
   ...
   case 210://CockRoach
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_cockroach", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}

	case 212://Alien Controller
		{
		
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_alien_controller", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}

   case 213://Flyer Flock
		{
		
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_flyer_flock", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
   ...
   case 214://Gman
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_gman", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
  ...
  case 215://Leech
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_leech", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 216://Nihilant
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_nihilanth", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 217://Osprey
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_osprey", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 218://Tentacle
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_tentacle", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 220://Turret
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_turret", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}

	case 221://Bullchicken
		{
		
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_bullchicken", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 222://Apache
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_apache", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 224://Sentry
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_sentry", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 225://Houndeye
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_houndeye", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 226://Assassin
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_human_assassin", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 227://Barnacle
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_barnacle", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 228://Babycrab
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("monster_babycrab", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 229://Bengala
		{
			...
			UTIL_MakeVectors( Vector( 0, pev->v_angle.y, 0 ) );
			Create("bengala", pev->origin + gpGlobals->v_forward * 128, pev->angles);
			break;
		}
	...
	case 101:
		...
		GiveNamedItem( "weapon_handflare" );//Flare Gun
	...
	case 106:
		...
		if ( pEntity )
		{
			...
			pEntity->pev->origin= pev->origin + gpGlobals->v_forward * 50;
		}
		break;
