...
void W_Precache(void)
{
	...
	//CS DUPLICATOR WEAPON
	UTIL_PrecacheOtherWeapon( "weapon_duplicator" );
//	UTIL_PrecacheOther( "ammo_AK47" );
	...
	UTIL_PrecacheOther( "ammo_FIVE" );



	//CS UMP WEAPON
	UTIL_PrecacheOtherWeapon( "weapon_ump45" );
	UTIL_PrecacheOther( "ammo_UMP45" );
	...
	UTIL_PrecacheOther( "ammo_TMP" );

		//CS POSERTOOL WEAPON
	UTIL_PrecacheOtherWeapon( "weapon_posertool" );
	...
	UTIL_PrecacheOtherWeapon("weapon_handgrenade");
		...
		// REMOVETOOL
	UTIL_PrecacheOtherWeapon("weapon_removetool");

	// PUNCH
	UTIL_PrecacheOtherWeapon("weapon_punch");
