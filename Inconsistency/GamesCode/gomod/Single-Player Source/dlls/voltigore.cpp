...
//#define		ISLAVE_AE_ZAP_POWERUP	( 1 )
#define		ISLAVE_AE_ZAP_SHOOT		( 1 )
#define		ISLAVE_AE_ZAP_DONE		( 2 )
...
LINK_ENTITY_TO_CLASS( monster_voltigore, CVoltigore );



TYPEDESCRIPTION	CVoltigore::m_SaveData[] = 
{
	DEFINE_FIELD( CVoltigore, m_iBravery, FIELD_INTEGER ),

	DEFINE_ARRAY( CVoltigore, m_pBeam, FIELD_CLASSPTR, ISLAVE_MAX_BEAMS ),
	DEFINE_FIELD( CVoltigore, m_iBeams, FIELD_INTEGER ),
	DEFINE_FIELD( CVoltigore, m_flNextAttack, FIELD_TIME ),

	DEFINE_FIELD( CVoltigore, m_voicePitch, FIELD_INTEGER ),

	DEFINE_FIELD( CVoltigore, m_hDead, FIELD_EHANDLE ),
...
//=========================================================
BOOL CVoltigore :: CheckRangeAttack2 ( float flDot, float flDist )
{
	return FALSE;
...
void CVoltigore :: Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/svencoop/voltigore.mdl");
...
void CVoltigore :: Precache()
{
	...
	PRECACHE_MODEL("models/svencoop/voltigore.mdl");
...
Schedule_t	slVoltiAttack1[] =
{
	{ 
		tlVoltiAttack1,
		ARRAYSIZE ( tlVoltiAttack1 ), 
...
void CVoltigore :: ArmBeam( int side )
{
	TraceResult tr;
	float flDist = 1.0;
...
//=========================================================
void CVoltigore :: WackBeam( int side, CBaseEntity *pEntity )
{
	Vector vecDest;
	float flDist = 1.0;
...
//=========================================================
void CVoltigore :: ZapBeam( int side )
{
	...
	m_pBeam[m_iBeams]->PointEntInit( tr.vecEndPos, entindex( ) );
	m_pBeam[m_iBeams]->SetEndAttachment( side < 0 ? 2 : 1 );
	m_pBeam[m_iBeams]->SetColor( 255, 255, 96 );
	m_pBeam[m_iBeams]->SetBrightness( 255 );
