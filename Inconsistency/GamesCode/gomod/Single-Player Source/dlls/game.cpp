...
cvar_t	disable_ia={"disable_ia","0", FCVAR_SERVER }; //IA ENABLED/DISABLED
cvar_t	pose_mode={"pose_mode","0", FCVAR_SERVER }; //IA ENABLED/DISABLED
cvar_t	hdr_simulate={"hdr_simulate","0", FCVAR_SERVER }; //HDR
cvar_t	ally	= {"ally","0", FCVAR_SERVER};// CVAR FOR ALLY NPCS
cvar_t	remove_npcs={"remove_npcs","1", FCVAR_SERVER }; //REMOVING ALLOWED IN MP
...
// CS P228 ROUND
cvar_t sk_plr_P228_bullet1 = {"sk_plr_P228_bullet1","100"};
cvar_t sk_plr_P228_bullet2 = {"sk_plr_P228_bullet2","100"};
cvar_t sk_plr_P228_bullet3 = {"sk_plr_P228_bullet3","100"};
...
// CS FIVESEVEN ROUND
cvar_t sk_plr_FIVE_bullet1 = {"sk_plr_FIVE_bullet1","0"};
cvar_t sk_plr_FIVE_bullet2 = {"sk_plr_FIVE_bullet2","0"};
cvar_t sk_plr_FIVE_bullet3 = {"sk_plr_FIVE_bullet3","0"};
...
// CS MP5 ROUND
cvar_t sk_plr_HKMP5_bullet1 = {"sk_plr_HKMP5_bullet1","0"};
cvar_t sk_plr_HKMP5_bullet2 = {"sk_plr_HKMP5_bullet2","0"};
cvar_t sk_plr_HKMP5_bullet3 = {"sk_plr_HKMP5_bullet3","0"};


// CS M3 ROUND
cvar_t sk_plr_BM3_bullet1 = {"sk_plr_BM3_bullet1","0"};
cvar_t sk_plr_BM3_bullet2 = {"sk_plr_BM3_bullet2","0"};
cvar_t sk_plr_BM3_bullet3 = {"sk_plr_BM3_bullet3","0"};
...
// Hand Flare
cvar_t	sk_plr_hand_Flare1 = {"sk_plr_hand_Flare1","0"};
cvar_t	sk_plr_hand_Flare2 = {"sk_plr_hand_Flare2","0"};
cvar_t	sk_plr_hand_Flare3 = {"sk_plr_hand_Flare3","0"};
...
void GameDLLInit( void )
{
	...
	CVAR_REGISTER (&disable_ia);
	CVAR_REGISTER (&pose_mode);
	CVAR_REGISTER (&hdr_simulate);
	CVAR_REGISTER (&ally);
	CVAR_REGISTER (&mp_chattime);
	CVAR_REGISTER (&remove_npcs);
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	// CS M3 Round
	CVAR_REGISTER ( &sk_plr_BM3_bullet1 );// {"sk_plr_FAMAS_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_BM3_bullet2 );// {"sk_plr_FAMAS_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_BM3_bullet3 );// {"sk_plr_FAMAS_bullet3","0"};
	...
	// CS P228 Round
	CVAR_REGISTER ( &sk_plr_P228_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_P228_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_P228_bullet3 );// {"sk_plr_DESERT_bullet3","0"};



	
	// CS P90 Round
	CVAR_REGISTER ( &sk_plr_P90_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_P90_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_P90_bullet3 );// {"sk_plr_DESERT_bullet3","0"};




	// CS GLOCK18 Round
	CVAR_REGISTER ( &sk_plr_GLOCK18_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_GLOCK18_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_GLOCK18_bullet3 );// {"sk_plr_DESERT_bullet3","0"};
	...
	// CS MP5 Round
	CVAR_REGISTER ( &sk_plr_HKMP5_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_HKMP5_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_HKMP5_bullet3 );// {"sk_plr_DESERT_bullet3","0"};
		...
		// CS UMP Round
	CVAR_REGISTER ( &sk_plr_UMP_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_UMP_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_UMP_bullet3 );// {"sk_plr_DESERT_bullet3","0"};


	
	// CS MAC10 Round
	CVAR_REGISTER ( &sk_plr_MAC10_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_MAC10_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_MAC10_bullet3 );// {"sk_plr_DESERT_bullet3","0"};
	...
	CVAR_REGISTER ( &sk_plr_AK47_bullet3 );// {"sk_plr_DESERT_bullet3","0"};
		...
		// CS M4A1 Round
	CVAR_REGISTER ( &sk_plr_M4A1_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_M4A1_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_M4A1_bullet3 );// {"sk_plr_DESERT_bullet3","0"};




	// CS FIVESEVEN Round
	CVAR_REGISTER ( &sk_plr_FIVE_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_FIVE_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_FIVE_bullet3 );// {"sk_plr_DESERT_bullet3","0"};


	// CS USP Round
	CVAR_REGISTER ( &sk_plr_USP_bullet1 );// {"sk_plr_DESERT_bullet1","0"};
	CVAR_REGISTER ( &sk_plr_USP_bullet2 );// {"sk_plr_DESERT_bullet2","0"};
	CVAR_REGISTER ( &sk_plr_USP_bullet3 );// {"sk_plr_DESERT_bullet3","0"};
	...
	// Hand Flare
	CVAR_REGISTER ( &sk_plr_hand_Flare1 );// {"sk_plr_hand_grenade1","0"};
	CVAR_REGISTER ( &sk_plr_hand_Flare2 );// {"sk_plr_hand_grenade2","0"};
	CVAR_REGISTER ( &sk_plr_hand_Flare3 );// {"sk_plr_hand_grenade3","0"};
