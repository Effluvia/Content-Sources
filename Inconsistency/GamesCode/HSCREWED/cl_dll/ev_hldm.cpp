...
void EV_FOTN( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		{
			case 0:
				gEngfuncs.pEventAPI->EV_WeaponAnimation ( FOTN_LPUNCH, 1 ); break;
			case 1:
				gEngfuncs.pEventAPI->EV_WeaponAnimation ( FOTN_RPUNCH, 1 ); break;
		}
	}
}
//======================
...
void EV_BeamKatana( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		{
			case 0:
				gEngfuncs.pEventAPI->EV_WeaponAnimation ( BEAMKATANA_ATTACK1MISS, 1 ); break;
			case 1:
				gEngfuncs.pEventAPI->EV_WeaponAnimation ( BEAMKATANA_ATTACK2MISS, 1 ); break;
			case 2:
				gEngfuncs.pEventAPI->EV_WeaponAnimation ( BEAMKATANA_ATTACK3MISS, 1 ); break;
		}
	}
}
//======================
...
void EV_TrainPitchAdjust( event_args_t *args )
{
	...
	{
		//gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_STATIC, sz, m_flVolume, ATTN_NORM, 5, pitch );
	}
}
