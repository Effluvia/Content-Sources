...
/*	//Does this weapon need the duckhunt UI?
	if (pw->hDuckHunt)
	{
		...
		SPR_Draw(0, dhx+10, dhy+5, &gHUD.GetSpriteRect(m_HUD_duckhunt2));
		}
		if (m_HUD_ammo2)
		{
		SPR_Set(gHUD.GetSprite(m_HUD_duckhunt2), 255, 255, 255); 
		SPR_Draw(0, dhx+25, dhy+5, &gHUD.GetSpriteRect(m_HUD_duckhunt2));
		}
		if (m_HUD_ammo3)
		{
		SPR_Set(gHUD.GetSprite(m_HUD_duckhunt2), 255, 255, 255); 
		SPR_Draw(0, dhx+40, dhy+5, &gHUD.GetSpriteRect(m_HUD_duckhunt2));
		}
