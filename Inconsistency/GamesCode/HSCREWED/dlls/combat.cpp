...
void CBaseMonster :: GibMonster( void )
{
	...
	{
		if ( CVAR_GET_FLOAT("violence_agibs") != 0 && CVAR_GET_FLOAT("ultraviolence") != 0 )	// Should never get here, but someone might call it directly
		{
			CGib::SpawnRandomGibs( pev, 40, 0 );	// Throw alien gibs
		}
		else if ( CVAR_GET_FLOAT("violence_agibs") != 0 && CVAR_GET_FLOAT("ultraviolence") == 0 )	// Should never get here, but someone might call it directly
		{
