...
enum KILLED_ENTITY_TYPE {
	KILLED_ENTITY_UNDEFINED,

	KILLED_ENTITY_ALIEN_CONTROLLER,
	KILLED_ENTITY_ALIEN_GRUNT,
	KILLED_ENTITY_ALIEN_SLAVE,
	KILLED_ENTITY_ARMORED_VEHICLE,
	KILLED_ENTITY_BABYCRAB,
	KILLED_ENTITY_BARNACLE,
	KILLED_ENTITY_BIG_MOMMA,
	KILLED_ENTITY_BULLSQUID,
	KILLED_ENTITY_GARGANTUA,
	KILLED_ENTITY_HEADCRAB,
	KILLED_ENTITY_HOUNDEYE,
	KILLED_ENTITY_HUMAN_ASSASSIN,
	KILLED_ENTITY_HUMAN_GRUNT,
	KILLED_ENTITY_ICHTYOSAUR,
	KILLED_ENTITY_MINITURRET,
	KILLED_ENTITY_SENTRY,
	KILLED_ENTITY_SNARK,
	KILLED_ENTITY_ZOMBIE,

	KILLED_ENTITY_SCIENTIST,
	KILLED_ENTITY_BARNEY,
	KILLED_ENTITY_GMAN,

	KILLED_ENTITY_GRENADE,
	KILLED_ENTITY_SNIPER,

	KILLED_ENTITY_NIHILANTH_CRYSTAL,
	KILLED_ENTITY_GONARCH_SACK
};
...
extern Vector		UTIL_VecSkew			( const Vector &vecSrc, Vector vecAiming, float rightOffset, edict_t *shooter );
