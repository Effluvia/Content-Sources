...
// still realize that they are teammates. (overridden for monsters that form groups)
	...
	float			MultiplyDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType );
...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	//
	static CBaseEntity *Create( char *szName, const Vector &vecOrigin, const Vector &vecAngles, edict_t *pentOwner = NULL, int weaponFlags = 0, int spawnFlags = 0 );
