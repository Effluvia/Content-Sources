...
#define HOE_SWITCH_GESTURE_WITH_MAIN_SEQUENCE
...
enum PlayerAnimEvent_t
{
	...
	PLAYERANIMEVENT_RESET_GESTURE_SLOT,
	PLAYERANIMEVENT_BARNACLE_GRAB,
	PLAYERANIMEVENT_BARNACLE_RELEASE,
...
#ifdef HOE_SWITCH_GESTURE_WITH_MAIN_SEQUENCE
	GESTURE_SLOT_ATTACK_AND_RELOAD_TRANSITION,
#endif
...
#ifdef HOE_SWITCH_GESTURE_WITH_MAIN_SEQUENCE
	virtual void SwitchGestureWithMainSequence( int iGestureSlot );
	void MaintainGestureTransition( int iGestureSlot );
	void KillTransitionGesture( int iGestureSlot );
#endif
...
#ifdef HOE_THIRDPERSON
	virtual bool HandleLadder( Activity &idealActivity );
	virtual bool HandleBarnacle( Activity &idealActivity );
	bool m_bIsOnBarnacle;
	bool m_bFirstBarnacleFrame;
#endif
