...
#ifdef HOE_DLL
	if ( !(actID >= LAST_SHARED_ACTIVITY || actID == lastActID + 1 || actID == ACT_INVALID) ) Warning(actName);
#endif
	lastActID = actID;
...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_IRONSIGHT );
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK_IRONSIGHT );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_IRONSIGHT );
	ADD_ACTIVITY_TO_SR( ACT_VM_IRONSIGHT_TRANSITION );
#endif // HOE_IRONSIGHTS

#ifdef HOE_DLL
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_IDLE_OFF );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_START_FAIL );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_START_EMPTY );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_START_READY );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_START );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_IDLE_HIT );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_ATTACK );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_IDLE_AIM );
	ADD_ACTIVITY_TO_SR( ACT_CHAINSAW_RUN );
#endif // HOE_DLL
}
