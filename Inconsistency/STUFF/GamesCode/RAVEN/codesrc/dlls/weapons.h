...
#define	WEAPON_M40A1			18
#define	WEAPON_DISPLACER		19
#define WEAPON_NAILGUN			20
#define WEAPON_RIFLE			21
...
#define NAILGUN_WEIGHT		30
#define RIFLE_WEIGHT		30
...
#define	_556_MAX_CARRY			100
#define	_762_MAX_CARRY			15
#define	NAILS_MAX_CARRY			180
#define	RIFLE_MAX_CARRY			120
...
#define SAW_MAX_CLIP			50
#define DEAGLE_MAX_CLIP			7
#define M40A1_MAX_CLIP			5
#define NAILGUN_MAX_CLIP		60
#define RIFLE_MAX_CLIP			40
...
#define AMMO_M40A1_GIVE			5
#define AMMO_NAIL_CLIP_GIVE		30
#define AMMO_RIFLE_CLIP_GIVE	40
...
typedef	enum
{
	...
	BULLET_PLAYER_DEAGLE, // crowbar swipe
	...
	BULLET_MONSTER_M40A1,
	BULLET_MONSTER_RIFLE
} Bullet;
...
public:
	...
	virtual BOOL	CanSuck( void ) { return TRUE; }
...
extern void SpawnBlood(Vector vecSpot, int bloodColor, float flDamage, int bitsDamageType = 0);
...
class CQ1Shotgun : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
public:
	...
	static CLaserSpot *CreateSpot( float spriteScale );
};
...
public:
	void MakeLive( float flScale );
	void EXPORT SuckThink( void );
	
	static CBlackHole *CreateBlackHole( void );
...
class CScopedRifle : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
