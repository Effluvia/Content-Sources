...
void CGameRules::RefreshSkillData ( void )
{
	...
	gSkillData.shamblerDmgSwipe = GetSkillCvar( "sk_shambler_dmg_swipe" );
	gSkillData.shamblerDmgSmash = GetSkillCvar( "sk_shambler_dmg_smash" );
	gSkillData.shamblerDmgZap = GetSkillCvar( "sk_shambler_dmg_zap" );

	//Soldier		
	gSkillData.soldierHealth = GetSkillCvar( "sk_soldier_health" );
	gSkillData.soldierShotgunPellets = GetSkillCvar( "sk_soldier_pellets" );
	...
	gSkillData.borisDmgZap = GetSkillCvar( "sk_boris_dmg_zap");
	...
	// Fgrunt 
	gSkillData.fgruntHealth = GetSkillCvar( "sk_fgrunt_health");
	gSkillData.fgruntDmgKick = GetSkillCvar( "sk_fgrunt_kick");
	gSkillData.fgruntShotgunPellets = GetSkillCvar( "sk_fgrunt_pellets");
	gSkillData.fgruntGrenadeSpeed = GetSkillCvar( "sk_fgrunt_gspeed");
...
// PLAYER WEAPONS
	...
	// Rifle round
	gSkillData.plrDmgRifle = GetSkillCvar( "sk_plr_rifle_bullet");
