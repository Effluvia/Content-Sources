...
================
*/
void SpawnBlood( Vector vecSpot, int bloodColor, float flDamage, int bitsDamageType )
{
	if( bitsDamageType & (DMG_SNIPER|DMG_NAIL) )
		UTIL_BloodStream( vecSpot, g_vecAttackDir, bloodColor, (int)flDamage );
...
void W_Precache(void)
{
	...
	UTIL_PrecacheOther( "item_vest" );
	UTIL_PrecacheOther( "item_battery" );
	UTIL_PrecacheOther( "item_antidote" );
	UTIL_PrecacheOther( "item_security" );
	UTIL_PrecacheOther( "item_longjump" );

	UTIL_PrecacheOther( "monster_boris" );
	UTIL_PrecacheOther( "monster_human_grunt_ally" );
	UTIL_PrecacheOther( "monster_human_grunt" );
	UTIL_PrecacheOther( "monster_q1soldier" );
	UTIL_PrecacheOther( "monster_q1shambler" );
	UTIL_PrecacheOther( "monster_q1dog" );

	// shotgun
	UTIL_PrecacheOtherWeapon( "weapon_shotgun" );
	UTIL_PrecacheOtherWeapon( "weapon_q1shotgun" );
	...
	UTIL_PrecacheOther( "ammo_m40a1_clip" );

	// deagle
	UTIL_PrecacheOtherWeapon( "weapon_desert_eagle" );

	// nailgun
	UTIL_PrecacheOtherWeapon( "weapon_nailgun" );
	UTIL_PrecacheOther( "ammo_nail_clip" );

	// scoped rifle
	UTIL_PrecacheOtherWeapon( "weapon_scopedrifle" );
	UTIL_PrecacheOther( "ammo_rifle_clip" );
