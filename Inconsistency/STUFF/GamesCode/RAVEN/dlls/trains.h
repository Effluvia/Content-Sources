...
#define SF_TRAIN_NO_PASS_TRIGGER	0x00016
#define SF_PLAT_TOGGLE		0x0001
#define SF_FUNCTRAIN_START_ON		512
#define SF_TRAIN_USE_ORIGIN			1024
...
class CModelTrackTrain : public CFuncTrackTrain
{
public:
	void Spawn( void );
	void Precache( void );
