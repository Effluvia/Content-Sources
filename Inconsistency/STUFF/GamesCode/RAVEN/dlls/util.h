...
extern void UTIL_VectorTransform (const vec3_t& in1, float in2[3][4], vec3_t& out);
extern void UTIL_AngleMatrix (const vec3_t& angles, float (*matrix)[4] );
extern void UTIL_VectorScale (const vec3_t& in, vec_t scale, vec3_t& out);
extern void UTIL_VectorAdd (const vec3_t& veca, const vec3_t& vecb, vec3_t& out);