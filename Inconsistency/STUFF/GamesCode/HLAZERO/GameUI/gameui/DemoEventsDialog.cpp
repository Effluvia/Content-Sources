...
CDemoEventsDialog::CDemoEventsDialog(vgui::Panel *parent, const char *name, IEngineWrapper * engine,
		IDemoPlayer * demoPlayer ) : Frame ( parent, name )
{
	...
	m_EventList->AddColumnHeader(0, "time", "Time", 32, true, RESIZABLE, RESIZABLE);
	m_EventList->AddColumnHeader(1, "type", "Type", 128, true, RESIZABLE, RESIZABLE);
