...
void* CreateInterface( const char *pName, int *pReturnCode )
{
	...
	//MODDD - gimmie the list
	for(pCur=InterfaceReg::s_pInterfaceRegs; pCur; pCur=pCur->m_pNext)
	{
		const char* daai = pCur->m_pName;
	}
	...
	for(pCur=InterfaceReg::s_pInterfaceRegs; pCur; pCur=pCur->m_pNext)
	{
		...
		//MODDD - NEW.  Do a strncmp (limit of strlen minus 3) to exclude the last 3 chars.
		//////////////////////////////////////////////////////////////////////////////////
		else{
			int theLen = strlen(pName);
			if(theLen > 3 && strlen(pCur->m_pName) > 3){
				// proceed
				if(strncmp(pCur->m_pName, pName, theLen-3) == 0){
