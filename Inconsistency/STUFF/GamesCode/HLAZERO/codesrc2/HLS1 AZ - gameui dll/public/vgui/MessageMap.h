...
//MODDD - MAJOR.  seems visual studio now wants the reference to a method to have an ampersand
// in front.  Which makes sense, but why was this ever allowedany other way?
