...
public:
	...
	//virtual void vagina1(void* arg1, void* arg2, void* arg3);
	//virtual void vagina2(void* arg1, void* arg2, void* arg3);
	//virtual void vagina3(void* arg1, void* arg2, void* arg3);
	...
	{
		m_bRunning = false;
		// because what else would call this.
	...
	//MODDD - last param no longer optional
	...
	//MODDD - didn't use to have these
	/*
	//-----------------------------------------------------------------------------
	// SRC specific stuff
...
bool CVGui::GetShouldVGuiControlSleep(void){
	return TRUE;
}
...
static void* __CreateCVGuiIVGui_interface() {
	return (IVGui *)&g_VGui;
}
static InterfaceReg __g_CreateCVGuiIVGui_reg(__CreateCVGuiIVGui_interface, VGUI_IVGUI_INTERFACE_VERSION);
...
/*
	...
	for (int i = 0; i < MAX_SAFE_PANELS; i++)
	{
		...
		{
			ivgui()->DPrintf2("%s - %s\n", m_PanelList[i].m_pPanel->Client()->GetName(), m_PanelList[i].m_pPanel->Client()->LOCAL_GetClassName());
		}
	}
*/
}
...
/*
void CVGui::vagina1(void* arg1, void* arg2, void* arg3){
	int arg1_i = (int)arg1;
...
*/
/*
void CVGui::vagina2(void* arg1, void* arg2, void* arg3){
	int arg1_i = (int)arg1;
	const char* arg1_s = (const char*)arg1;
	int arg2_i = (int)arg2;
	const char* arg2_s = (const char*)arg2;
...
void CVGui::vagina3(void* arg1, void* arg2, void* arg3){
	int arg1_i = (int)arg1;
	const char* arg1_s = (const char*)arg1;
	int arg2_i = (int)arg2;
	const char* arg2_s = (const char*)arg2;
...
//	_private->_surfaceBaseDar[i]->setEmulatedCursorPos(cursorX, cursorY);
	...
	// messenging
	{
		...
		for (int i = count - 1; i >= 0; i-- )
		{
			...
			//MODDD - give default
			PostMessage(tickTarget, new KeyValues("Tick"), NULL, 0);
		}
	}
...
VPANEL CVGui::AllocPanel()
{
	...
	/*
	//MODDD - is that a good idea?
	if(firstPanelEva){
		surface()->SetEmbeddedPanel((VPANEL)panel);
		firstPanelEva = FALSE;
	}
	*/
...
{
	//return;
	const char* daa = (const char*)ipanel;
	//return;

	VPanel* tempRef = (VPanel*)ipanel;
	
	// ????

	CVGui* tempRefer = (CVGui*)ipanel;
	VPanelWrapper* tempRefer2 = (VPanelWrapper*)ipanel;

	CVGui* otherRefer = &g_VGui;

	BOOL deyEqua = (tempRefer == otherRefer);
	BOOL doseEqua = (tempRefer2 == &__g_VPanelWrapper_singleton);


	int ax;
	int ay;
	// TEST!!!
	tempRefer2->GetChild(ipanel, 0);
	//tempRefer2->GetSize(ipanel, ax, ay);
...
void CVGui::PanelDeleted(VPanel *focus)
{
	...
	//(*focus->_vptr.VPanel[5])(focus)

	VPANEL maiPanel = (VPANEL)focus;
	
	// 'daSurface' here was given a virtual function table in hl.exe? 
	// uh-oh.  Gotta use the decomp's vgui2.so to see what that would've looked like at the time...
	ISurface* daSurface = surface();


	//MODDD - disabled, test
	
	daSurface->ReleasePanel(maiPanel);
...
void CVGui::AddTickSignal(VPANEL panel, int intervalMilliseconds /*=0*/ )
{
	...
	{
		strncpy( t->panelname, ((VPanel *)panel)->Client()->LOCAL_GetClassName(), sizeof( t->panelname ) );
	}
...
{
	PostMessage(panel, new KeyValues("Delete"), NULL, 0);
}
...
void CVGui::ShutdownMessage(unsigned int shutdownID)
{
	...
	{
		ivgui()->PostMessage((VPANEL)((VPanel *)panel)->GetChild(i), new KeyValues("ShutdownRequest", "id", shutdownID), NULL, 0);
	}

	// post to the top level window as well
	ivgui()->PostMessage(panel, new KeyValues("ShutdownRequest", "id", shutdownID), NULL, 0);
}
