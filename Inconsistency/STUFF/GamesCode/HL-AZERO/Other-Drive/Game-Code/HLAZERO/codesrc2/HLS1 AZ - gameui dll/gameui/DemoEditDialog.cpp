...
extern char * COM_VarArgs(char *format, ...);

//////////////////////////////////////////////////////////////////////
// Construction/Destruction
//////////////////////////////////////////////////////////////////////

CDemoEditDialog::CDemoEditDialog(vgui::Panel *parent, const char *name, IEngineWrapper * engine,
		IDemoPlayer * demoPlayer ) : Frame ( parent, name )
{
	...
	SetTitle( "WHO THE HELL DO YOU THINK YOU ARE", true );

	//MODDD - unrelated to all this insanity.  Just a blank 3rd parameter.  Nah, ABC it is
	m_TypeBox = new CLabeledCommandComboBox( this, "TypeBox", "ABC" );

	//MODDD - DUMMIED.  Too much missing.
	/*
	for ( i = 0; i < DRC_CMD_LAST; i++)
    {
        m_TypeBox->AddItem( DRC_CMD_NAME[i], DRC_CMD_NAME[i] );
    }
	*/
...
void CDemoEditDialog::SetDataField( int index, char * label, char * text)
{
