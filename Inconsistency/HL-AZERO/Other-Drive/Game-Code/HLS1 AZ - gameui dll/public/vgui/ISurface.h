...
//-----------------------------------------------------------------------------
//MODDD - no IAppSystem now.
// Oooooorrrrr in the ISurface's case it makes things run better 
// for the hl.exe provided surface.   what?
...
// 026 uses the one from hl.exe, 027 from this codebase.
// (latter only works if including vgui2.dll in the game files)
