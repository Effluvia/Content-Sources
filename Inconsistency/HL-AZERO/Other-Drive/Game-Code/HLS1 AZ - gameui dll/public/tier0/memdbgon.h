...
//MODDD - CRITICAL.  FUCK THIS.  THIS BAD.
// This makes the rest of the codebase forget what 'new' and 'delete' mean for template or list types, or the combo?  unsure.   But... yeah.   ugh.
// Still don't think _DEBUG mode is worth it anyway, just caues any assert's to turn into garbage.
// But to avoid those errors, pretend _DEBUG were off here
#undef _DEBUG
