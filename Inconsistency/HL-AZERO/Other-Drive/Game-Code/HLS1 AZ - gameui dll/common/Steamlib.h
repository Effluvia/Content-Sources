...
//MODDD - No return type?   What even is STEAM_RegisterAppProgressCallback and the other one then.
// Adding in 'void' to each
// Waitwaitwaitwait no.   You mean this is ok?     FUCKING *H*O*W*
// not it isn't???
