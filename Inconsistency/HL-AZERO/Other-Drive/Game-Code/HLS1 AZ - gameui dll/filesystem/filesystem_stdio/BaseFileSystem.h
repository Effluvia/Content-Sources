...
//MODDD - REMEMBER TO live long and prosper
//#include <sys/stat.h>
#include "../../vs6_include/SYS/STAT.H"
...
public:
	...
	//MODDD - pathID Added!
	virtual const char			*FindFirst( const char *pWildCard, FileFindHandle_t *pHandle, char *pathID );
	...
	// !!! AddPackFile !!!
	virtual void AddPackFiles(char *pPath);
	// !!! OpenFromCacheForRead !!!
	virtual FileHandle_t OpenFromCacheForRead(char *pFileName, char *pOptions,char *pathID);
	// !!! AddSearchPathNoWrite !!!
	virtual void AddSearchPathNoWrite(char *pPath, char *pathID);
...
//MODDD - oops, nothing refers to this.  EHhhhh make it anyway
// singleton accessor
