...
static CRunGameEngine __g_CRunGameEngine_singleton;
//EXPOSE_SINGLE_INTERFACE_GLOBALVAR(CRunGameEngine, IRunGameEngine, RUNGAMEENGINE_INTERFACE_VERSION, __g_CRunGameEngine_singleton)
static void* __CreateCRunGameEngineIRunGameEngine_interface() {
	return (IRunGameEngine *)&__g_CRunGameEngine_singleton;
}
static InterfaceReg __g_CreateCRunGameEngineIRunGameEngine_reg(__CreateCRunGameEngineIRunGameEngine_interface, RUNGAMEENGINE_INTERFACE_VERSION);
