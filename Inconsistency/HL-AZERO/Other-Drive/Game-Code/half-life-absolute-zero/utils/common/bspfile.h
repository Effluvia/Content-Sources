...
//MODDD - "CONTENTS_" macro constants moved to const.h to be available for all
// the codebase, including pm_shared (C lang) stuff.

//MODDD - NOTE. asm_i386.h, eh?  That filename shows up in FTE QuakeWorld
// executable soure code as well.
