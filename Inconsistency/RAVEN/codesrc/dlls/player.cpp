...
void LinkUserMessages( void )
{
	...
	gmsgELight = REG_USER_MSG("ELight", 13); 
	gmsgFog = REG_USER_MSG("Fog", 7); 
	gmsgBlackHole = REG_USER_MSG("Goatse", 14);
	gmsgModelCamera = REG_USER_MSG("ModelCamera", -1);
	gmsgWeather = REG_USER_MSG("Weather", -1);
}

LINK_ENTITY_TO_CLASS( player, CBasePlayer );

edict_t* CBasePlayer :: GetViewEntity( void )
{
	return m_pViewEntity;
}

int CBasePlayer :: GetAttachment( void )
{
	return m_iAttachment;
}

void CBasePlayer :: SetViewEntity( edict_t* pEntity, int iAttachment )
{
	m_pViewEntity = pEntity;
...
void CBasePlayer::TabulateAmmo()
{
	...
	ammo_saw = AmmoInventory( GetAmmoIndex( "556" ) );
...
void CBasePlayer::CheatImpulseCommands( int iImpulse )
{
	...
	case 101:
		...
		GiveNamedItem( "ammo_nail_clip" );
		GiveNamedItem( "ammo_rifle_clip" );
#ifndef OEM_BUILD
		...
		GiveNamedItem( "ammo_sawclip" );
		GiveNamedItem( "weapon_desert_eagle" );
		GiveNamedItem( "weapon_saw" );
		GiveNamedItem( "weapon_sniperrifle" );
		GiveNamedItem( "ammo_m40a1_clip" );
		GiveNamedItem( "weapon_displacer" );
		GiveNamedItem( "weapon_scopedrifle" );
#endif
		GiveNamedItem( "weapon_q1shotgun" );
